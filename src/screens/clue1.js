    ...
    render() {
        ...
        return (
            <div className='amazing'>
                <div className='eee-img3' style={{ backgroundImage: 'url(' + data.stops[0].medias[0].url + ')' }}>
                    ...
                    <div style={{ marginTop: 200, marginLeft: 20 }}>
                        ...
                        <h2 className='color-white line-height-7'>One</h2>
                    </div>
                </div>

                <div className='eee-view'>

                    <p style={{ fontWeight: 600, fontSize: 19, color: '#000' }}>{data.stops[0].title}</p>
                    <p style={{ fontSize: 18, color: '#4a4a4a', marginTop: 20, lineHeight: 1.4 }}>{data.stops[0].subTitle}</p>
                    <p style={{ fontSize: 13, lineHeight: 1.6 }}>{data.stops[0].text}</p>
                    ...
                    <Link onClick={window.scrollTo(0, 0)} to='/experience/1/clue1/detail'>
                ...
                <div style={{ textAlign: 'center', color: '#c4c4c4' }} onClick={() => this.setState({ modal1: true })}>
                    <div style={{ width: 80, padding: 12, display: 'inline-block' }} onClick={this.openModal}>
